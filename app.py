...
# 1. Configuración de página e idioma para evitar traductor
...
st.markdown(
    ...
    <html lang="es">
    <style>
        /* Evitar que se active el teclado en móviles al usar selectores */
...
if jugador_sel == "- Seleccionar Jugador -":
    ...
    with tab2:
        ...
        fig_c.update_layout(barmode='group', title=f"Comparativa: {metricas_dict[met_comp]}")
